...
class AiLogic:
    ...
    def should_roll(self, npc_score, player_score):
        ...
        if (self.win_target == 10): #Kommer att kolla så att inte ai stannar närmare än 90+
            return True
        ...
        if (self.__turn_score < target): #Här väljs det ifall Ai'n ska slå igen eller stanna
            return True
        else:
